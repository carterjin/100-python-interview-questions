- [Python Basics](#python-basics)
  * [Python Language Basic](#python-language-basic)
    ...
    + [16. Flatten [[1,2],[3,4],[5,6]] to be [1,2,3,4,5,6]](#16-flatten-123456-to-be-123456)
    + [17. Invalid dictionary keys](#17-invalid-dictionary-keys)
    + [18. How to exchange the keys and values in {'A':1, 'B':2}](#18-how-to-exchange-the-keys-and-values-in-a1-b2)
    ...
    + [22. function or variable names with '_' prefix and suffix](#22-function-or-variable-names-with-_-prefix-and-suffix)
    ...
    + [43. use one line of python code for 1+2+3+10248](#43-use-one-line-of-python-code-for-12310248)
...
- [Python Advanced](#python-advanced)
  ...
  * [Design Pattern](#design-pattern)
    ...
    + [83. What's your understanding on decorators and show a timer decorator](#83-whats-your-understanding-on-decorators-and-show-a-timer-decorator)
    ...
    + [88. Use one line of code to group 1-N integers into groups of 3. Example:[1,2,3,4,5,6] ->[[1,2,3],[4,5,6]]](#88-use-one-line-of-code-to-group-1-n-integers-into-groups-of-3-example123456--123456)
